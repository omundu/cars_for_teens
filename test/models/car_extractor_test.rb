...
class CarExtractorTest < ActiveSupport::TestCase
  test "get car array" do
    html_doc = Nokogiri::HTML(
      "<html>
        <body>
          <table>
            <tr>
              <td>kia rio</td><td>2008-10</td>
            </tr>
            <tr>
              <td>vw ion</td><td>2011</td>
            </tr>
            <tr>
              <td>gmc tc</td><td>2012 and later</td>
            </tr>
          </table>
        </body>
      </html>"
    ...
    expected_result = [
      Car.new({manufacturer: "kia", years: [2008, 2009, 2010], suggested_price: 0, model: "rio"}),
      Car.new({manufacturer: "vw", years: [2011], suggested_price: 0, model: "ion"}),
      Car.new({manufacturer: "gmc", years: [2012, 2013, 2014], suggested_price: 0, model: "tc"})
    ]
